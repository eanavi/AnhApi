...
{
    public class ServicioParametro : ServicioGenerico<Parametro, int>, IServicioParametro
    {
        private readonly ContextoAppBD _contextoBd;
        private readonly ILogger<ServicioParametro> _logger;
        private readonly IMapper _mapper;

        public ServicioParametro(ContextoAppBD contexto, ILogger<ServicioParametro> logger, IMapper mapper) : base(contexto, logger)
        {
