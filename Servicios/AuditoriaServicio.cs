...
{
    public class AuditoriaServicio<T, TKey> : IAuditoriaServicio<T, TKey> where T:class, IAuditable   
    {
        private readonly ContextoAppBD _contexto;
        private readonly ILogger<AuditoriaServicio<T, TKey>> _logger;
        private readonly DbSet<T> _dbSet;

        public AuditoriaServicio(ContextoAppBD contexto, ILogger<AuditoriaServicio<T, TKey>> logger)
        {
