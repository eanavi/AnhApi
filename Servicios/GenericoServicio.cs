...
{
    public class GenericoServicio<T, TKey> : IGenericoServicio<T, TKey> where T:class, ICampoEstado
    {
        ...
        #region Constructor
        public GenericoServicio(ContextoAppBD contextoBd, ILogger<GenericoServicio<T, TKey>> logger)
        {
