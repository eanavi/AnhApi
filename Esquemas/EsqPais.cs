...
namespace AnhApi.Esquemas
{
    ...
    /// </summary>
    public class EsqPais : PaisCreacion // Hereda de PaisCreacion para incluir los campos básicos
    {
        [Required(ErrorMessage = "El ID del país es requerido.")]
    ...
    public class PaisConDepartamentosEsq : EsqPais
    {
        [Required(ErrorMessage = "La lista de departamentos no puede ser nula.")]
        public ICollection<DepartamentoListado> Departamentos { get; set; } = new List<DepartamentoListado>();
    }
